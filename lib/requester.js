...
Requester.prototype.postRequest = function (endpoint, data, token, callback) {
    request({
        method: 'POST',
        url: endpoint,
        form: data,
...
Requester.prototype.postJsonRequest = function (endpoint, data, token, callback) {
    request({
        method: 'POST',
        url: endpoint,
        body: data,
...
Requester.prototype.getRequest = function (endpoint, token, callback) {
    request({
        method: 'GET',
        url: endpoint,
        headers: headers.getHeaders(token),
...
Requester.prototype.getRequestHtml = function (endpoint, token, callback) {
    request({
        method: 'GET',
        url: endpoint,
        headers: headers.getHeaders(token)
