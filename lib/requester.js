...
Requester.prototype.postRequest = function (cookies, token, endpoint, data, callback) {
...
Requester.prototype.postJsonRequest = function (cookies, token, endpoint, data, callback) {
    var request = setCookies(cookies);
    request({
        method: 'POST',
        url: endpoint,
...
Requester.prototype.getRequest = function (cookies, token, endpoint, callback) {
    var request = setCookies(cookies);
    request({
        method: 'GET',
        url: endpoint,
...
Requester.prototype.getRequestHtml = function (cookies, token, endpoint, callback) {
    var request = setCookies(cookies);
    request({
        method: 'GET',
        url: endpoint,
